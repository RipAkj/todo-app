...
function Update(filterItemArray = itemArray) {
    ...
    filterItemArray.forEach((eachItem, index) => {
        ...
        markElement.textContent = eachItem.done?"Not Done":"Done";
        ...
        editElement.src="./Pictures/edit-button-svgrepo-com.svg";
        ...
        deleteElement.src="./Pictures/delete-1487-svgrepo-com.svg";
